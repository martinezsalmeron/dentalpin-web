...
export const MODULES: ModuleEntry[] = [
  {
    ...
    domain: 'clinical',
    icon: 'tooth',
    title: { es: 'Odontograma', en: 'Odontogram', fr: 'Odontogramme', pt: 'Odontograma' },
    tagline: {
  ...
  },
  {
    ...
    domain: 'clinical',
    icon: 'chart',
    title: { es: 'Periodontograma', en: 'Periodontogram', fr: 'Parodontogramme', pt: 'Periodontograma' },
    tagline: {
  ...
  },
  {
    ...
    domain: 'clinical',
    icon: 'shield',
    title: { es: 'Pacientes', en: 'Patients', fr: 'Patients', pt: 'Pacientes' },
    tagline: {
    ...
    features: [
      ...
      { es: 'Registro de consentimiento RGPD.', en: 'GDPR consent tracking.', fr: 'Suivi du consentement RGPD.', pt: 'Registo do consentimento RGPD.' },
      { es: 'Notas internas libres.', en: 'Free-form internal notes.', fr: 'Notes internes en texte libre.', pt: 'Notas internas em texto livre.' },
      {
  ...
  },
  {
    ...
    domain: 'clinical',
    icon: 'shield',
    title: { es: 'Historial clínico', en: 'Clinical history', fr: 'Dossier clinique', pt: 'Histórico clínico' },
    tagline: {
  ...
  },
  {
    ...
    domain: 'clinical',
    icon: 'sparkles',
    title: { es: 'Plan de tratamiento', en: 'Treatment plan', fr: 'Plan de traitement', pt: 'Plano de tratamento' },
    tagline: {
  ...
  },
  {
    ...
    domain: 'operations',
    icon: 'calendar',
    title: { es: 'Agenda', en: 'Calendar', fr: 'Agenda', pt: 'Agenda' },
    tagline: {
    ...
    features: [
      ...
      { es: 'Zona horaria consciente.', en: 'Timezone-aware.', fr: 'Gestion des fuseaux horaires.', pt: 'Gestão de fusos horários.' },
    ],
  ...
  },
  {
    ...
    domain: 'operations',
    icon: 'card',
    title: { es: 'Presupuestos', en: 'Budgets', fr: 'Devis', pt: 'Orçamentos' },
    tagline: {
    ...
    features: [
      ...
      { es: 'Totales auto-calculados.', en: 'Auto-calculated totals.', fr: 'Totaux calculés automatiquement.', pt: 'Totais calculados automaticamente.' },
      {
      ...
      { es: 'Archivo de presupuestos antiguos.', en: 'Archive of old budgets.', fr: 'Archivage des anciens devis.', pt: 'Arquivo de orçamentos antigos.' },
    ],
  ...
  },
  {
    ...
    domain: 'operations',
    icon: 'card',
    title: { es: 'Facturación', en: 'Invoicing', fr: 'Facturation', pt: 'Faturas' },
    tagline: {
    ...
    features: [
      ...
      { es: 'Edición con auditoría.', en: 'Invoice editing with audit.', fr: 'Modification des factures tracée.', pt: 'Alteração de faturas com rasto.' },
      { es: 'PDF con la marca de la clínica.', en: 'PDF with clinic branding.', fr: 'PDF aux couleurs du cabinet.', pt: 'PDF com a marca da clínica.' },
      {
  ...
  },
  {
    ...
    country: 'ES',
    customPage: true,
    title: { es: 'Verifactu', en: 'Verifactu', fr: 'Verifactu', pt: 'Verifactu' },
    tagline: {
  ...
  },
  {
    ...
    domain: 'operations',
    icon: 'chart',
    title: { es: 'Reportes', en: 'Reports', fr: 'Rapports', pt: 'Relatórios' },
    tagline: {
  ...
  },
  {
    ...
    domain: 'platform',
    icon: 'plug',
    title: { es: 'Sistema de módulos', en: 'Module system', fr: 'Système de modules', pt: 'Sistema de módulos' },
    tagline: {
    ...
    features: [
      ...
      { es: 'Seeds YAML por módulo.', en: 'YAML seeds per module.', fr: 'Seeds YAML par module.', pt: 'Seeds YAML por módulo.' },
      {
  ...
  },
  {
    ...
    domain: 'platform',
    icon: 'plug',
    title: { es: 'API REST completa', en: 'Full REST API', fr: 'API REST complète', pt: 'API REST completa' },
    tagline: {
  ...
  },
  {
    ...
    domain: 'platform',
    icon: 'sparkles',
    title: { es: 'Agente de IA', en: 'AI agent', fr: 'Agent IA', pt: 'Agente de IA' },
    tagline: {
  ...
  },
  {
    ...
    icon: 'whatsapp',
    customPage: true,
    title: { es: 'WhatsApp', en: 'WhatsApp', fr: 'WhatsApp', pt: 'WhatsApp' },
    tagline: {
...
export function moduleBySlug(slug: string): ModuleEntry | undefined {
  return MODULES.find(
    (m) => m.slug === slug || m.slugEn === slug || m.slugFr === slug || m.slugPt === slug
  );
}
