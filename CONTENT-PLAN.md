...
| OrisDent Q (OrisLine) | `dentalpin-vs-orisdent` | `orisline.com`. Publishes a whole product family (OrisDent Q, the cloud OrisDent Air, OrisLab Q for labs). A suite sold as one is the closest thing Italy has to our module argument, so meet it head-on. **OrisLine is a brand of Henry Schein ONE Italia S.r.l.**: the site footer and the privacy policy name it as publisher and titolare del trattamento (consultato il 5 agosto 2026). That makes it the third Henry Schein One property in this queue, after Dentally and Software of Excellence in A3 |
